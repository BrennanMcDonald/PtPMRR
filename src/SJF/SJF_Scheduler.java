...
public class SJF_Scheduler {
    ...
    private static final Logger logger = LogManager.getLogger(SJF_Scheduler.class);
    ...
    private static void printCloudletList(List<Cloudlet> list) {
        ...
        logger.info("Makespan using SJF: " + makespan);
        logger.info("Cost using SJF: " + cost);
        logger.info("Total CPU using SJF: " + CPU);
    }
