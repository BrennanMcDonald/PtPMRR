...
public class PtPMRRScheduler {
    ...
    private static PtPMRRDatacenterBroker createBroker(String name) throws Exception {
        return new PtPMRRDatacenterBroker(name);
    }
    ...
    public static void run() {
        ...
        try {
            ...
            PtPMRRDatacenterBroker broker = createBroker("Broker_0");
